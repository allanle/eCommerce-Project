...
<div class="catalogue_wrapper">
    <div class="catalogue_wrapper_left">
        ...
        ?>
        <a href="/?page=catalogue-item&amp;category=<?php echo $category['id']; ?>&amp;id=<?php echo $row['id']; ?>"><img src="<?php echo $image; ?>" alt=<?php echo Helper::encodeHtml($row['name'], 1); ?>" widtth="<?php echo $width; ?>" /></a>    
    </div>
